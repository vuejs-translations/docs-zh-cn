...
对于情景 1，一个可行的办法是将共享状态 “提升” 到共同的祖先组件上去，再通过 props 传下来。然而在深层次的组件树结构中这么做的话，很快就会使得代码变得繁琐冗长。这回导致另一个问题：[props 深潜](/guide/components/provide-inject.html#prop-drilling)。
