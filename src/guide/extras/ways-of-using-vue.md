...
此外还有一些更高层级的 [Vue 框架](/guide/quick-start#frameworks)，它们构建于该范式之上，内置了对 SSR 的支持，可用于开发全栈应用。
...
Vue 团队维护了一个名为 [VitePress](https://vitepress.dev/) 的静态站点生成器，你正在阅读的文档就是基于它构建的，并且它支持这两种 SSG 形式！此外，也可以看看其他通常支持 SSG 的 [Vue 框架](/guide/quick-start#frameworks)。
