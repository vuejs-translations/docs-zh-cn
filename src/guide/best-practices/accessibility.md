...
Web 无障碍访问 (也称为 a11y) 是指创建可供任何人都可以使用的网站的做法——无论是残疾人、低速网络、老旧或损坏的硬件条件还是处于某种不方便的环境下。例如，在视频中添加字幕，既能为聋哑人用户提供帮助，也能使某些身处嘈杂环境中、听不到手机声音的用户也能正常观看视频。同样地，确保你的文字样式没有处于太低的对比度，可以让低视力用户和在明亮的阳光下使用手机的用户都有帮助。
